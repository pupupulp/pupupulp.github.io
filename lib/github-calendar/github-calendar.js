                            ...
                            if (i.global_stats !== !1) {
                                var m = r(n("svg", d).outerHTML),
                                    ...
                                    y = n("<div>", {
                                        ...
                                        html: '<span class="text-muted">Contributions in the last year</span>\n<span class="contrib-number counter">' + m.last_year + ' total</span>\n<span class="text-muted">' + o(a.subtract(new Date, 1, "year"), s) + " &ndash; " + o(new Date, s) + "</span>"
                                    }),
                                    v = n("<div>", {
                                        "class": "contrib-column table-column",
                                        html: '<span class="text-muted">Longest streak</span>\n<span class="contrib-number counter">' + m.longest_streak + ' days</span>\n<span class="text-muted">' + h + "</span>"
                                    }),
                                    M = n("<div>", {
                                        "class": "contrib-column table-column",
                                        html: '<span class="text-muted">Current streak</span>\n<span class="contrib-number counter">' + m.current_streak + ' days</span>\n<span class="text-muted">' + g + "</span>"
                                    });
                                d.appendChild(y), d.appendChild(v), d.appendChild(M);

                                $('.stat-contribs-header').html('Contributions in the last year');
                                $('.stat-contribs').html(m.last_year);
                                $('.stat-contribs-footer').html(o(a.subtract(new Date, 1, "year"), s) + " &ndash; " + o(new Date, s));
                                
                                $('.stat-lstreak-header').html('Longest coding streak');
                                $('.stat-lstreak').html(m.longest_streak);
                                $('.stat-lstreak-footer').html(h);
                            
                                $('.stat-cstreak-header').html('Current coding streak');
                                $('.stat-cstreak').html(m.current_streak);
                                $('.stat-cstreak-footer').html(g);
